...
def main():
    ...
    resp = httpx.get(f"https://api.github.com/repos/{repo}/git/refs/heads/main", headers=headers)
    if resp.status_code != 200:
        resp = httpx.get(f"https://api.github.com/repos/{repo}/git/refs/heads/master", headers=headers)
